...
#     - Handles consistent folder structures for all phases (training, evaluation, pruning, retraining).
#     - Creates standard subfolders under <model>/<exp>/pruned/<ratios>/ automatically after pruning.
...
#         # Pruned model base directory
#         self.pruned_dir = self.base_dir / save_cfg.get("subfolder", "pruned") / self.suffix

#         # Define the 4 standard subfolders (auto-created after pruning)
...
#         # Pruned model file path
#         self.pruned_model = self.pruned_model_dir / save_cfg.get("filename", "pruned_model.pth")

#         # Create the main pruning folder and its substructure
#         self._ensure_pruning_structure()
...
#     # ------------------------------------------------------------
#     def _ensure_pruning_structure(self):
#         """Ensure all subfolders under pruned/<ratios>/ exist."""
#         for path in [
#             self.pruned_dir,
#             self.pruned_model_dir,
#             self.pruned_eval_dir,
#             self.retrain_pruned_dir,
#             self.retrained_pruned_eval_dir,
#         ]:
