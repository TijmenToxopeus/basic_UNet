...
README-friendly qualitative examples for all three datasets are generated by:

[`src/notebooks/qualitative_readme_examples.ipynb`](/mnt/hdd/ttoxopeus/basic_UNet/src/notebooks/qualitative_readme_examples.ipynb)

The notebook:

- selects one representative case per dataset
- runs slice-wise inference from the configured baseline checkpoints
- renders each slice as `[Input | GT | Prediction | Overlay]`
- exports one GIF plus static PNG summaries per dataset under `results/qualitative_readme/`
...
![ACDC qualitative GIF](results/qualitative_readme/acdc/acdc_qualitative.gif)

Static previews:

- [Middle slice 4-panel](results/qualitative_readme/acdc/middle_slice_4panel.png)
- [Overlay summary](results/qualitative_readme/acdc/overlay_summary.png)

### M&M

![M&M qualitative GIF](results/qualitative_readme/mm/mm_qualitative.gif)

Static previews:

- [Middle slice 4-panel](results/qualitative_readme/mm/middle_slice_4panel.png)
- [Overlay summary](results/qualitative_readme/mm/overlay_summary.png)

### STONE

![STONE qualitative GIF](results/qualitative_readme/stone/stone_qualitative.gif)

Static previews:

- [Middle slice 4-panel](results/qualitative_readme/stone/middle_slice_4panel.png)
- [Overlay summary](results/qualitative_readme/stone/overlay_summary.png)
